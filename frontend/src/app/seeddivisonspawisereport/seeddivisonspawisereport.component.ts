...
@Component({
  selector: 'app-seeddivisonspawisereport',
  templateUrl: './seeddivisonspawisereport.component.html',
  styleUrls: ['./seeddivisonspawisereport.component.css']
})
export class SeeddivisonspawisereportComponent implements OnInit {
    ...
    if ((!this.ngForm.controls["crop_type"].value)) {
      ...
      const param = {
        search: {
          ...
          crop_codes:this.ngForm.controls['crop_name'].value,  
          type:'seeddivision'       
        }
      }
      this.cropNameArr= this.selectCrop_group ?  this.selectCrop_group  :'';
      this.spa_namesArr = spa_name 
     console.log(this.cropNameArr,'this.cropNameArr')
      this.masterService.postRequestCreator('getIndentorSpaWiseBreederSeedIndentor', null, param).subscribe(data => {
        let agencyArr = [];
        let cropName = [];
        let arr = [];
  ...
  getIndentorSpaYear() {
    ...
    this.masterService.postRequestCreator('get-indentor-year-list-second-indentor', null, param).subscribe(data => {
  ...
  getIndentorSpaSeason(newValue) {
    ...
    this.masterService.postRequestCreator('get-indentor-season-list-second-indentor', null, param).subscribe(data => {
  ...
  getIndentorCropType(newValue) {
    ...
    this.masterService.postRequestCreator('getindentorCropTypelistSecondIndentor', null, param).subscribe(data => {
  ...
  getIndentorVariety(newValue) {
    ...
    this.masterService.postRequestCreator('getIndentorSpaNameBreederSeedIndentor', null, param).subscribe(data => {
  ...
  getIndentorCrop(newValue) {
    ...
    this.masterService.postRequestCreator('getindentorCroplistindentor', null, param).subscribe(data => {
