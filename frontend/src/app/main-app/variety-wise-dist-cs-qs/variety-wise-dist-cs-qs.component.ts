...
@Component({
  selector: 'app-variety-wise-dist-cs-qs',
  templateUrl: './variety-wise-dist-cs-qs.component.html',
  styleUrls: ['./variety-wise-dist-cs-qs.component.css']
})
export class VarietyWiseDistCsQsComponent implements OnInit {
  ...
  @ViewChild(PaginationUiComponent) paginationUiComponent: PaginationUiComponent | undefined = undefined;
   ...
   onSearch() {
     ...
     if ((!this.ngForm.controls["crop_type"].value)) {
      ...
      //  console.log(crop_name)
       ...
       this.zsrmServiceService.postRequestCreator('get-zsrm-cs-qs-dist-data', null, param).subscribe(data => {
   ...
   getIndentorSpaYear() {
    const route = "get-zsrm-cs-qs-dist-year";
     this.zsrmServiceService.getRequestCreator('get-zsrm-cs-qs-dist-year', null, null).subscribe(data => {
      if (data.Response.status_code === 200) {
   ...
   getIndentorSpaSeason(newValue) {
    ...
    const apiUrl = `get-zsrm-cs-qs-dist-season?${queryParams.join('&')}`;
   ...
   getIndentorCropType(newValue) {
    ...
    const apiUrl = `get-zsrm-cs-qs-dist-croptype?${queryParams.join('&')}`;
     this.zsrmServiceService.getRequestCreator(apiUrl).subscribe(data => {
      console.log(data)
   ...
   getIndentorCrop(newValue) {
    ...
    const apiUrl = `get-zsrm-cs-qs-dist-crop?${queryParams.join('&')}`;
    console.log(apiUrl);
     this.zsrmServiceService.getRequestCreator(apiUrl).subscribe(data => {
      let res = data && data.Response && data.Response.data ? data.Response.data : '';
      res.forEach(element => {
