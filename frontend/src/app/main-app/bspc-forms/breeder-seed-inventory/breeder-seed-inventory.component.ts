...
@Component({
  selector: 'app-breeder-seed-inventory',
  templateUrl: './breeder-seed-inventory.component.html',
  styleUrls: ['./breeder-seed-inventory.component.css'],
  encapsulation: ViewEncapsulation.None
})

export class BreederSeedInventoryComponent implements OnInit {
