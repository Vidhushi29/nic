...
@Component({
  selector: 'app-allocation-breeder-spa-list',
  templateUrl: './allocation-breeder-spa-list.component.html',
  styleUrls: ['./allocation-breeder-spa-list.component.css']
})
export class AllocationBreederSpaListComponent implements OnInit {
  ...
  loadDraftBsp(loadPageNumberData: number = 1, searchData: any | undefined = undefined) {
    ...
    this.breederService.postRequestCreator("get-allocation-to-spa-list", null,
      {
