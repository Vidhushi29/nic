...
@Component({
  selector: 'app-allocation-seed-production-draft',
  templateUrl: './allocation-seed-production-draft.component.html',
  styleUrls: ['./allocation-seed-production-draft.component.css']
})
export class AllocationSeedProductionDraftComponent implements OnInit {
  ...
  getPageData() {
    this.restService.getNodalBreederSeedAllocationList().subscribe(data => {
