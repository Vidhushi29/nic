...
@Component({
  selector: 'app-srp-status-report',
  templateUrl: './srp-status-report.component.html',
  styleUrls: ['./srp-status-report.component.css']
})
export class SrpStatusReportComponent implements OnInit {
@ViewChild(PaginationUiComponent) paginationUiComponent: PaginationUiComponent | undefined = undefined;
  ...
  totalData: any;
    ...
    const apiUrl = `get-srp-status-report?${queryParams.join('&')}`;
          ...
          this.finalData = data.Response.data;
