...
@Component({
  selector: 'app-seeddivisionindentwise',
  templateUrl: './seeddivisionindentwise.component.html',
  styleUrls: ['./seeddivisionindentwise.component.css']
})
export class SeeddivisionindentwiseComponent implements OnInit {
  ...
  onSearch() {
    ...
    if ((!this.ngForm.controls["crop_type"].value)) {
      ...
      // })
      this.master.postRequestCreator('getIndentorCropWiseBreederSeedindentor', null, param).subscribe(data => {
        let cropNameArr = []
        let arr = [];
      ...
      this.reportData=res
        ...
        for (let val of this.dummyData) {
          ...
          sum+=val && val.crop_total_indent ?  parseFloat(val.crop_total_indent):0;
  ...
  getIndentorSpaYear() {
    ...
    this.master.postRequestCreator('get-indentor-year-list-second-indentor', null, param).subscribe(data => {
  ...
  getIndentorSpaSeason(newValue) {
    ...
    this.master.postRequestCreator('get-indentor-season-list-second-indentor', null, param).subscribe(data => {
  ...
  getIndentorCropGroup(newValue) {
    ...
    this.master.postRequestCreator('getindentorCropGrouplistindentor', null, param).subscribe(data => {
  ...
  getIndentorCropType(newValue) {
    ...
    this.master.postRequestCreator('getindentorCropTypelistSecondIndentor', null, param).subscribe(data => {
