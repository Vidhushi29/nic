...
@Component({
  selector: 'app-dashboard-nodal-second',
  templateUrl: './dashboard-nodal-second.component.html',
  styleUrls: ['./dashboard-nodal-second.component.css']
})
export class DashboardNodalSecondComponent implements OnInit {
  chart: any
  chart_sec: any;
  ngForm!: FormGroup;
  bspCard = false;
  ...
  constructor(private fb: FormBuilder, private service: SeedDivisionService, private breederService: BreederService) {
    // super();
    this.createForm();
