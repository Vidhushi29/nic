...
module.exports = app => {
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/crop-group-list`, auth, users.viewCropGroupList);

    app.post(`${process.env.MICRO_SERVICE}/api/getUserCodeForLotNumber`, auth, users.getUserCodeForLotNumber);
